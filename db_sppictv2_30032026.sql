...
CREATE DATABASE IF NOT EXISTS `db_sppict` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_sppict`;
...
-- Dumping data for table db_sppict.audit_logs: ~18 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `meetings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `title` enum('PRA-JTICTNS','JTICTNS','JPICTNS') COLLATE utf8mb4_unicode_ci NOT NULL,
  `meeting_number` enum('1','2','3','4','5','6') COLLATE utf8mb4_unicode_ci NOT NULL,
  `year` year NOT NULL,
  `date` date NOT NULL,
  `time` time NOT NULL,
  ...
  `minutes_file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table db_sppict.meetings: ~0 rows (approximately)
INSERT INTO `meetings` (`id`, `title`, `meeting_number`, `year`, `date`, `time`, `venue`, `status`, `project_update_deadline`, `minutes_file`, `agenda`, `created_at`, `updated_at`) VALUES
	(1, 'PRA-JTICTNS', '2', '2026', '2026-04-15', '09:30:00', 'Bilik Mesyuarat BTM', 'Aktif', '2026-04-10', 'meetings/tPjUyXqwOmrRL7rFeEMbTquzJ7dhhIbUUkwXPvay.pdf', '<ol><li>Kata Alu-Aluan Pengerusi.</li><li>Pengesahan Minit Mesyuarat JTICTNS Bil. 5/2025.</li><li>Perkara-perkara Berbangkit.</li><li>Pembentangan</li><li>Hal-hal Lain.</li><li>Penangguhan Mesyuarat.</li></ol><div><br></div>', '2026-03-11 22:20:17', '2026-03-11 22:20:17');
...
-- Dumping data for table db_sppict.migrations: ~11 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `projects` (
  ...
  `officer_position` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `officer_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `officer_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Perancangan',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `objective` text COLLATE utf8mb4_unicode_ci,
  `scope` text COLLATE utf8mb4_unicode_ci,
  `implementation_period` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `funding_source` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_reference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `application_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Draf',
  `urusetia_remarks` text COLLATE utf8mb4_unicode_ci,
  `proposal_file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table db_sppict.projects: ~6 rows (approximately)
INSERT INTO `projects` (`id`, `project_title`, `project_code`, `description`, `estimated_department_cost`, `start_date`, `end_date`, `agency_id`, `created_by`, `officer_name`, `officer_position`, `officer_email`, `officer_phone`, `status`, `created_at`, `updated_at`, `objective`, `scope`, `implementation_period`, `funding_source`, `approval_reference`, `application_status`, `urusetia_remarks`, `proposal_file`, `presentation_file`) VALUES
	(2, 'test 1', 'BTM/2026/001', NULL, 125000.00, NULL, NULL, 81, 6, NULL, NULL, NULL, NULL, 'Perancangan', '2026-02-22 18:15:55', '2026-03-10 18:02:51', '<ul><li>obj a</li><li>obj b</li><li>obj c</li></ul>', '<ul><li>skop 1</li><li>skop 2</li><li>skop 3</li></ul>', '20 bulan', 'bajet mengurus', 'Surat Kelulusan : BTM-100/1/210', 'Draf', NULL, 'documents/2/kBWtw7JK4iYdDm2yMyrqtXwNBR14GoHVcvHg2hlr.pdf', 'documents/2/xsb64OxzUN41q0LiLR1DYgspXuZwQiOBeuA1GUfC.pdf'),
	(4, 'test lagi', 'JHEAINS/2026/002', NULL, 150000.00, NULL, NULL, 42, 8, NULL, NULL, NULL, NULL, 'Perancangan', '2026-02-22 22:41:42', '2026-02-22 22:41:42', 'obj 1\r\nobj 2\r\nobj 3', 'skop 1\r\nskop 2\r\nskop 3', '12 bulan', 'bajet mengurus', 'Surat Kelulusan : JHEAINS-100/1/200', 'Draf', NULL, NULL, NULL),
	...
	(7, 'test BTM', 'BTM/2026/002', NULL, 250000.00, NULL, NULL, 81, 8, 'Test Pengguna', 'Pegawai Teknologi Maklumat', 'pengguna@test.com', '0121111111', 'Perancangan', '2026-02-22 23:48:31', '2026-03-10 18:08:12', 'obj 1\r\nobj 2\r\nobj 3', 'skop 1\r\nskop 2\r\nskop 3', '12 bulan', 'bajet mengurus', 'Surat Kelulusan : BTM-100/1/200', 'Hantar - Tunggu Semakan Urus Setia', NULL, 'documents/7/Nwx9NNXscBieEWXhIPC19R9hox9TvmVJIM89LV9t.pdf', 'documents/7/mgDOZAYUWeljHKmc8bIowLpkF6CB0oREKMjSHu1c.pdf'),
	(9, 'cubaan', 'BTM/2026/003', NULL, 545000.00, NULL, NULL, 81, 8, 'Test Pengguna', 'Pegawai Teknologi Maklumat', 'pengguna@test.com', '0121111111', 'Perancangan', '2026-02-23 17:21:31', '2026-03-10 19:10:49', '<ul><li>objektif 1</li><li>objektif 2</li><li>objektif 3</li></ul>', '<div>skop 1 skop 2 skop 3</div>', '24 bulan', 'bajet mengurus', 'Surat Kelulusan : BTM-100/1/202', 'Hantar - Tunggu Semakan Urus Setia', NULL, 'documents/9/12dj1DYbsud6wr5pMrP3addwQSOTZV8WKSv4FpNH.pdf', 'documents/9/urgYDTfZqPbH0H50qlBR2Zba0hmpnBaPngA2dne0.pdf');
...
-- Dumping data for table db_sppict.project_details: ~7 rows (approximately)
...
-- Dumping data for table db_sppict.sessions: ~4 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('N1P6LLQSL0rVfhWVZQPmRf7WmzfSSTt9e913gFeg', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36', '', 1773637050),
	('RwzBeM6qBElbIlWMQEmb7TmyMOVOMYIswJe6xG31', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36', '', 1773374071),
	('s8unotpOztz6OkIaysALV5oAUtpke4bm34oNpgnv', 6, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36', '', 1773640259),
	('w5F0Jnov2ojkFB1zMCW1Zz0RF3wVMKuSKQzTUyIK', 6, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36', '', 1773304024);
...
-- Dumping data for table db_sppict.users: ~4 rows (approximately)
